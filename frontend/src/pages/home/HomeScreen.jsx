      ...
      <div className="relative h-screen text-white">
        ...
        px-8 md: px-16 lg:px-32">
          ...
          <div className="flex mt-8 ">
            ...
            className="bg-white hover:bg-white/80 text-black font-bold py-2 
            px-4 rounded mr-4 flex items-center"
            >
            ...
            <Link to={`/watch/${trendingContent?.id}`}
            className="bg-gray-500/70 hover:gray-500 text-white py-2 px-4 rounded flex items-center"
            >
